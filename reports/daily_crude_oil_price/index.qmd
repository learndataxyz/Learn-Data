...
oil_data_raw <- read_csv("reports/daily_crude_oil_price/Export.csv") |>
  mutate(Date = dmy(Date),
         Price = as.numeric(Price)) |>
  arrange(Date)

oil_data <- read_csv("reports/daily_crude_oil_price/Export.csv") |>
  mutate(Date = dmy(Date),
         Price = as.numeric(Price)) |>
  arrange(Date)
...
summary_table_gt <- summary_table %>%
  ...
  tab_source_note(
    source_note = "Source: Central Bank of Nigeria (CBN)"
  )

summary_table_gt
gtsave(summary_table_gt,"reports/daily_crude_oil_price/images/summary_table_gt.png")
