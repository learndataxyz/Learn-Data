...
![](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/LearnData_Branding_(5).png)
...
2.  Inside the project directory, create a Python [virtual environment](https://www.notion.so/Language_Translator-3ba29b2dbeab41fea3b705b64e4fea05?pvs=21). This environment maintains the library versions used in your code, ensuring your code is reproducible every time it runs.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image.png)
...
3.  Run the following code to activate the virtual environment and start working on it.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%201.png)
...
2.  Click on **Deploy**, then **Inference API**.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%202.png)

3.  Copy the code displayed to you and paste it into `utilis.py`.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%203.png)
...
3.  Run the code below on your terminal to launch the Streamlit application.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%204.png)
...
4.  Create a button to process any input given in the text area.
    ...
    -   Save your file and go to the Streamlit application to see the changes.
        ...
        ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%205.png)

5.  Paste the Hindi text given earlier into the text area and click on translate.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%206.png)
...
1.  Try to translate a text, and go back to your dashboard under the **Content Manager** menu to see the saved text.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2012.png)
...
3.  Update `main.py` with the following code to create a History button where users can view previous translations.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2013.png)
...
1.  Go to **Deploy** on your admin dashboard menu, and click **Deploy to Strapi Cloud**.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2014.png)

2.  Sign in to Strapi Cloud.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2015.png)

3.  Click on **Create Project** to create a new project.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2016.png)

4.  Select the **Free trial** and click on **GitHub** to permit Strapi to authorize your **GitHub** account.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2017.png)
...
5.  After completing the authorization steps, you should have something like this. Select the account you want Strapi to access and the project repository.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2018.png)

6.  Give the application a display name, and leave other options as the default.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2019.png)
...
7.  Under **Show Advanced Settings**, type the backend directory, which is `/backend`, leave other options as default, and click on **Create Project**.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2020.png)

8.  You can see the application build and deploy logs displayed while the application is being built.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2021.png)

9.  Click on the **Visit app** to open up the live admin panel.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2022.png)

10. Like before, when you open the admin panel locally, fill in your credentials and log in.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2023.png)
...
2.  Click on **Create app**.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2024.png)
...
3.  Please complete the form by providing the project repository and the path of the streamlet application, which is `/frontend/main.py`. If you have authorized Streamlit to access your GitHub repositories, it will list all the repositories in your GitHub account.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2025.png)

4.  Click on **Advanced Settings**, type in your `HUGGING_FACE_TOKEN` as it is in your `.env` file, and **Save**.

    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2026.png)
...
6.  Now, you have successfully deployed the Streamlit application.
    ...
    ![image.png](Language_Translator%203ba29b2dbeab41fea3b705b64e4fea05/image%2027.png)
