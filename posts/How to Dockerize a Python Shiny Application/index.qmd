...
-   A sample Shiny application in your [`app.py`](http://app.py) file, use the one below if you don’t have one.
...
![Run the Docker Image. Image by Author.](image 1.png){fig-alt="How to Dockerize a Python Shiny Application"}
...
![](image 2.png){fig-alt="How to Dockerize a Python Shiny Application"}
...
![Login to Docker. Image by Author.](image 3.png){fig-alt="How to Dockerize a Python Shiny Application"}
...
![Go to Docker Hub. Image by Author.](image 4.png){fig-alt="How to Dockerize a Python Shiny Application"}
